        ...
        children: [
            {
                ...
                title: '后台任务',
                access: '/jobs',
                name: 'system_control_jobs',
                component: () => import('@/views/system_control/jobs.vue')
            },
            {
                path: '/sysMenu/index',
                icon: 'pound',
                title: '菜单管理',
                access: '/sysMenu/index',
                name: 'system_control_index',
                component: () => import('@/views/system_control/sysMenu_index.vue')
            },
            {
                path: '/sysAccount/manager',
                icon: 'pound',
                title: '用户管理',
                access: '/sysAccount/manager',
                name: 'system_control_sysAccount',
                component: () => import('@/views/system_control/sysAccount.vue')
            },
            {
                path: '/sysRole/manager',
                icon: 'pound',
                title: '角色管理',
                access: '/sysRole/manager',
                name: 'system_control_sysRole',
                component: () => import('@/views/system_control/sysRole.vue')
            }
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                title: '表单提交',
                name: 'demo_form',
                component: () => import('@/views/demo/form/form.vue')
            }
        ]
    },
    {
